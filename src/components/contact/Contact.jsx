...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "fahdsherif2005@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+20 1552196809",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I’m passionate about transforming complex datasets into stories that reveal what truly matters.
              </p>
            </div>
